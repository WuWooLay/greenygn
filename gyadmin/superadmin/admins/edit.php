                            ...
                            <div class="col-md-4 justify-content-center">
                                ...
                                <div class="text-center mb-3">
                                    <div class="TeamImage">
                                        ...
                                        <div class="mt-3"> <h6> <?= $result['position'] ?> </h6> </div>
                                            <!-- Other Position -->
                                            <?php
                                                if(strlen($result['other_position']) > 0 ) {
                                                     foreach(explode(",",$result['other_position']) as $v) {
                                            ?>
                                                <div> 
                                                     <?= $v ?>
                                                </div>
                            ...
                            <div class="col-md-8">
                                ...
                                <form method="POST">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <input value="<?= $result['position'] ?>" name="position" type="text" class="form-control" id="position" placeholder="Enter Position">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <input value="<?= $result['other_position'] ?>" name="other_position" type="text" class="form-control" id="other_position" placeholder="Enter Other Position">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input value="1" <?= $result['admin_role_id'] == 1 ? 'checked=checked' : '' ?> type="radio" id="customRadioInline1" name="admin_role_id" class="custom-control-input">
                                            <label class="custom-control-label" for="customRadioInline1"> Super Admin</label>
                                        </div>

                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input value="2"  <?= $result['admin_role_id'] == 2 ? 'checked=checked' : '' ?> type="radio" id="customRadioInline2" name="admin_role_id" class="custom-control-input">
