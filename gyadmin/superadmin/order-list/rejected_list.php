<?php
    ...
    // Functions
    require __DIR__. "/functions/rejected/getdata.php";
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="card border-primary  text-center mb-3">
                               ...
                               <div class="list-group">
                                    ...
                                    <a href="/gyadmin/superadmin/order-list/pending_list.php" class="list-group-item list-group-item-action"> Pending List </a>
                                    <a href="/gyadmin/superadmin/order-list/rejected_list.php" class="list-group-item list-group-item-action list-group-item-primary"> Reject List </a>
                               </div>
